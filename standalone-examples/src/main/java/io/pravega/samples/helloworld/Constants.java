 ...
 *   
 */
package io.pravega.samples.helloworld;
...
public class Constants {
    protected static final String DEFAULT_SCOPE = "nautilus-samples";
    protected static final String DEFAULT_STREAM_NAME = "helloStream";
    protected static final String DEFAULT_CONTROLLER_URI = "tcp://127.0.0.1:9091";
